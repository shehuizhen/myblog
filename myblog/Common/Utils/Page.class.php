...
// | 修改: kylin <mq0211@qq.com> <有一些小bug，已经修改过来了>
...
class Page
{
    ...
    private $config = array(
        ...
        // 'header' => '<li class="paginate_button"><a class="num">共 %TOTAL_ROW% 条记录</a></li>',
     ...
     * [myUrl 处理分页数据，兼容前台传过来的checkbox多选]

     * @Author   Kylin    <maqiangmail@yztctech.com>

     * @DateTime 2016-10-12T17:05:33+0800
    ...
    private function myUrl($parameter)
    {
    ...
    public function show()
    {
        ...
        $this->url = $this->myUrl($this->parameter);
        ...
        $this->lastSuffix ? $this->config['last'] = $this->totalPages : $this->config['last'] = '尾页';
