...
<head>
    ...
    <link type="image/x-icon" href="/Public/Admin//favicon.ico" rel="shortcut icon" />
    <link href="/Public/Admin//favicon.ico" rel="bookmark icon" />
</head>
...
<div class="container">
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <br /><br />
            <form action="/Home/useradd" method="post">
            <div class="panel">
                <div class="panel-head"><strong>个人博客注册</strong></div>
                <div class="panel-body" style="padding:30px;">
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input" name="nickname" placeholder="昵称" data-validate="required:请填写昵称" />
                    ...
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="password" class="input" name="repassword" placeholder="请再次输入密码" data-validate="required:请再次填写密码" />
                            <span class="icon icon-key"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="field">
                            ...
                            <img src="/code?" width="80" height="32" class="passcode" onclick="this.src+=Math.random()"/>
                        </div>
                    </div>
                </div>
